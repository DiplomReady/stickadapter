...
public abstract class StickyHeaderAdapter extends RecyclerView.Adapter<StickyHeaderAdapter.ViewHolder> {
    public static final String TAG = "StickyHeaderAdapter";
    ...
    protected int getSectionPosition(int position) {
        final int section = getAdapterPositionSection(position);
        final Section sectionObject = mSections.get(section);

        return position - sectionObject.position;
    }
